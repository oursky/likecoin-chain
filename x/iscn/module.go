...
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, sMux *runtime.ServeMux) {
	//nolint:errcheck
	types.RegisterQueryHandlerClient(context.Background(), sMux, types.NewQueryClient(clientCtx))
}
